      ...
      <div className="container">
        ...
        >
          {CERTIFICATES.map((cert, i) => (
            <div
              key={cert.title}
              className={`cert-flip sr sr-d${i + 1}`}
              style={{ height: 240 }}
            >
        ...
        >
          <div style={{ flex: 1, minWidth: 220 }}>
            ...
            >
              Phát triển và duy trì hệ thống thông tin của bảo tàng. Áp dụng
              kiến thức fullstack vào môi trường thực tế chuyên nghiệp.
            </p>
          </div>
